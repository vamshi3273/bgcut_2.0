...
const Toolbar = ({ editor }: { editor: Editor }) => (
  <div className="border-border shrink-0 overflow-x-auto border-b p-2">
    <div className="flex max-w-max flex-wrap items-center gap-px">
  ...
  ({ value, onChange, maxHeight, className, editorContentClassName, ...props }, ref) => {
    ...
    return (
      <MeasuredContainer
        ...
        ref={ref}
        className={cn(
          'border-input bg-card focus-within:border-ring focus-within:ring-ring/15 flex h-auto min-h-72 w-full flex-col rounded-md border shadow-xs transition-[color,box-shadow] outline-none focus-within:ring-[3px]',
      ...
      >
        ...
        <EditorContent
          editor={editor}
          className={cn('minimal-tiptap-editor h-full overflow-auto', editorContentClassName, {
